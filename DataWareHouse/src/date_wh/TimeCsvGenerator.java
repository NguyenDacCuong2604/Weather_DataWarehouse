...
public class TimeCsvGenerator {
    ...
    private static final String CSV_FILE_PATH = "time_dim.csv";
    ...
    private static void writeTimeRow(FileWriter writer, int hour, int minute, int second) throws IOException {
        String timeRow = String.format("%2d,%02d,%02d,%02d,%s\n", id++,hour, minute, second, String.format("%02d:%02d:%02d", hour, minute, second));
